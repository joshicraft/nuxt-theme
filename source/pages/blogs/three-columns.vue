    ...
    <section class="section">
      <main class="container">
        ...
        <div class="columns is-centered is-multiline">
          <div v-for="blog in blogs" :key="blog.id" data-aos="fade" class="column is-one-third mb4">
...
<script>
  ...
  export default {
    name: "blogs-two-columns",
    layout: 'base',
    mixins: [Helper],
    created () {
      this.$store.commit('SET_PAGE_TITLE', "Three columns blog layout")
    },
    components: {
      Pagination,
    },
